        ...
        <table class="min-w-full table-auto">
          <thead>
            <tr class="bg-[#F0F2F7] text-center">
              ...
              <th class="px-2 py-2 text-[#22305C] font-medium">Subjects</th>
              <th class="px-2 py-2 text-[#22305C] font-medium">SN
              ...
              <th class="px-2 py-2 text-[#22305C] font-medium">Session N</th>
          ...
          <tbody class="text-[#22305C]">
            <tr v-for="(row, index) in paginatedData" :key="index" class="relative even:bg-[#FFFFFF]">
              <!-- Table Data -->
              ...
              <td class="px-4 py-2 text-center text-sm">{{ row.sessionn }}</td>
              <td class="px-4 py-2 text-gray-500 text-center text-sm">Ben Ammara Bachir</td>
...
export default {
  ...
  data() {
    return {
      activeTab: "regular",
      tableData: [
        { class: "A1.1 | En | Adults", students: 15, days: "Weekend Days", time: "Mornings", sessionn: "12", startDate: "26/12/2024", color: 'bg-[#F98182]' },
        { class: "A1.1 | Fr | Teens", students: 14, days: "Weekend Days", time: "Mornings", sessionn: "12", startDate: "26/12/2024", color: 'bg-[#14B5C7]' },
        { class: "A1.1 | Fr | Kids", students: 13, days: "Weekend Days", time: "Mornings", sessionn: "12", startDate: "26/12/2024", color: 'bg-[#FEB726]' },
        { class: "A1.1 | Fr | Adults", students: 8, days: "Weekend Days", time: "Mornings", sessionn: "12", startDate: "26/12/2024", color: 'bg-[#F98182]' },
        { class: "A1.1 | Fr | Adults", students: 15, days: "Weekend Days", time: "Mornings", sessionn: "12", startDate: "26/12/2024", color: 'bg-[#F98182]' },
        { class: "A1.1 | Fr | Adults", students: 0, days: "Weekend Days", time: "Mornings", sessionn: "12", startDate: "26/12/2024", color: 'bg-[#14B5C7]' },
        { class: "A1.1 | Fr | Adults", students: 5, days: "Weekend Days", time: "Mornings", sessionn: "12", startDate: "26/12/2024", color: 'bg-[#F98182]' },
