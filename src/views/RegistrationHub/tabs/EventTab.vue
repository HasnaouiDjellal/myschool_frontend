  ...
  <div class="p-4 bg-gray-100 rounded-lg">
    ...
    <div class="relative flex justify-between py-2 overflow-x-auto rounded whitespace-nowrap">
      ...
      <div class="inline-flex ml-3 overflow-hidden rounded-lg min-w-max">
        ...
        <button class="bg-[#3D548D] text-white text-sm  px-4 py-2 rounded-lg hover:bg-blue-800 ">New
          Registration</button>
        <button class="bg-[#3D548D] text-white text-sm ml-4 px-4 py-2 rounded-lg hover:bg-blue-800  ">New Event</button>
      </div>
        ...
        <table class="min-w-full table-auto">
          <thead>
            <tr class="bg-[#F0F2F7] text-center">
              <th class="px-2 py-2 text-[#22305C] font-medium">Events</th>
...
export default {
  data() {
    return {
      activeTab: "regular",
      tableData: [
        { class: "Spring Camp", students: 15, days: "Mon | Tue | Wed", time: "18:00", teacher: "Hannane Legmairi", startDate: "26/12/2024" },
        { class: "Winter Camp", students: 14, days: "Mon | Tue | Wed", time: "18:00", teacher: "Hannane Legmairi", startDate: "26/12/2024" },
        { class: "Summer Camp", students: 13, days: "Mon | Tue | Wed", time: "18:00", teacher: "Hannane Legmairi", startDate: "26/12/2024" },
        { class: "Autumn Camp ", students: 8, days: "Mon | Tue | Wed", time: "18:00", teacher: "Hannane Legmairi", startDate: "26/12/2024" },
      ],
      rowsPerPage: 10,
      currentPage: 1,
      paginatedData: [],
