    ...
    <table class="min-w-full border-separate" style="border-spacing: 0 10px;">
      <tbody class="overflow-y-auto rounded-lg text-md font-semibold">
        <tr
          ...
          <td class="py-3 px-4 border-l border-t border-b border-[#939BAD] rounded-l-lg">{{ row.event }}</td>
...
return {
  activeTab: "regular",
    tableData2: [
      ...
      {  event: "Event Name", balance: 3000, classtype: "Paid", date: "DD/MM/YYYY", comment: "comment" },
      {  event: "Event Name", balance: 3000, classtype: "Paid", date: "DD/MM/YYYY", comment: "comment" },
      {  event: "Event Name", balance: 3000, classtype: "Exempt", date: "DD/MM/YYYY", comment: "comment" },
      {  event: "Event Name", balance: 3000, classtype: "Exempt", date: "DD/MM/YYYY", comment: "comment" },
      {  event: "Event Name", balance: 3000, classtype: "Exempt", date: "DD/MM/YYYY", comment: "comment" },
      {  event: "Event Name", balance: 3000, classtype: "Exempt", date: "DD/MM/YYYY", comment: "comment" },
      {  event: "Event Name", balance: 3000, classtype: "Exempt", date: "DD/MM/YYYY", comment: "comment" },
      {  event: "Event Name", balance: 3000, classtype: "Exempt", date: "DD/MM/YYYY", comment: "comment" },
      {  event: "Event NameX", balance: 3000, classtype: "Exempt", date: "DD/MM/YYYY", comment: "comment" },
