...
function goToGroupDetails() {
  router.push('GroupeDetailsTutoring')
}
</script>
                ...
                <table class="min-w-full table-auto">
                    <thead>
                        <tr class="bg-[#F0F2F7] text-center">
                            ...
                            <th class="px-2 py-2 text-[#22305C] font-medium">Subject</th>
                            ...
                            <th class="px-2 py-2 text-[#22305C] font-medium">Day</th>
                            <th class="px-2 py-2 text-[#22305C] font-medium">Time</th>
                            <th class="px-2 py-2 text-[#22305C] font-medium">Sessions no.
                                <div class="inline-flex items-center justify-end">
                                    <a href="#"><svg class="w-3 h-3 ms-1.5" aria-hidden="true"
                                            xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                                            <path
                            ...
                            <th class="px-2 py-2 text-[#22305C] font-medium">Progress</th>
                    ...
                    <tbody class="text-[#22305C]">
                        <tr v-for="(row, index) in paginatedData" :key="index" :class="getRowClass(row.students)"
                            ...
                            <td class="px-4 py-2 text-center text-sm">{{ row.day }}</td>
                            <td class="px-4 py-2 text-center text-sm">{{ row.time }}</td>
                            <td class="px-4 py-2 text-center text-sm">{{ row.sessionno }}</td>
                            <td class="px-4 py-2 text-center text-sm">{{ row.progress }}</td>
