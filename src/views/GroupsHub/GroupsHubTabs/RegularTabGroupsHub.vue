                ...
                <table class="min-w-full table-auto">
                    <thead>
                        <tr class="bg-[#F0F2F7] text-center">
                            ...
                            <th class="px-2 py-2"></th>
                            <th class="px-2 py-2 text-[#22305C] font-medium">GID</th>
                            ...
                            <th class="px-2 py-2 text-[#22305C] font-medium">Timing</th>
                            <th class="px-2 py-2 text-[#22305C] font-medium">Sessions Progress
                                <div class="inline-flex items-center justify-end">
                                    <a href="#"><svg class="w-3 h-3 ms-1.5" aria-hidden="true"
                                            xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                                            <path
                            ...
                            <th class="px-2 py-2 text-[#22305C] font-medium">Room</th>
                    ...
                    <tbody class="text-[#22305C]">
                        <tr v-for="(row, index) in paginatedData" :key="index" :class="getRowClass(row.students)"
                            ...
                            <td class="px-4 py-2 text-center text-sm">{{ row.sn }}</td>
                            ...
                            <td class="px-4 py-2 text-center text-sm">
                                <input class="" id="status" type="text" :value="row.status" :class="[
                                    ...
                                    row.status === 'Freeze' ? 'bg-[#E3F2FD] text-[#3279B2] border-[#E3F2FD]' : ''
                                ]" disabled />
                            </td>
