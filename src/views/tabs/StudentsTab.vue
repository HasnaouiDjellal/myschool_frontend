        ...
        <table class="min-w-full table-auto bg-[#F0F2F7]">
          <thead>
            <tr class="bg-[#F0F2F7] text-center">
              ...
              <th class="px-2 py-2 text-[#22305C] font-medium">City</th>
              <th class="px-2 py-2 text-[#22305C] font-medium">Address</th>
              <th class="px-2 py-2 text-[#22305C] font-medium">Gender</th>
              <th class="px-2 py-2 text-[#22305C] font-medium">Balance</th>
              <th class="px-2 py-2 text-[#22305C] font-medium">Parent Name </th>
              <th class="px-2 py-2 text-[#22305C] font-medium">Phone Number 1</th>
          ...
          <tbody class="text-[#22305C]">
            <tr v-for="(row) in students" class="relative odd:bg-[#F7F8FA]">
              ...
              <td class="px-4 py-2 text-center text-md">{{ row.city_town }}</td>
              <td class="px-4 py-2 text-center text-md">{{ row.street }}</td>
              <td class="px-4 py-2 text-center text-md">{{ row.gender }}</td>
              <td class="px-4 py-2 text-center text-md"> DZD</td>
              <td class="px-4 py-2 text-center text-md">{{ row.parent_name }}</td>
              <td class="px-4 py-2 text-center text-md">{{ row.phone_number1 }}</td>
              <td class="px-4 py-2 text-center text-md">{{ row.phone_number2 }}</td>
